package algorithms.labs.practise.runtime;

import algorithms.labs.practise.util.RandomPermutations;
import algorithms.labs.practise.util.Util;
...
public class SortTester {
	private final String PACKAGE = "algorithms.labs.practise.sortroutines";
	...
	public SortTester() {
		...
		try{
			String[] arr = new String[]{"BubbleSort",
					"InsertionSort",
					"SelectionSort"};
			for(String st : arr){
				Sorter next = createInstance(st);
				sorters.push(next);
...
//				System.out.println(Stream.of(testArrays[sortIndex][i]).toList());
//				}
				finish = time();
