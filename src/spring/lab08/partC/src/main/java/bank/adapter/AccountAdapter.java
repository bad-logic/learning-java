...
public class AccountAdapter {
    ...
    public static AccountDto toAccountDto(Account data){
        List<AccountEntryDto> entries = data.getEntryList().stream().map(l-> new AccountEntryDto(l.getDate(),l.getAmount(),l.getDescription(),l.getFromAccountNumber(),l.getFromPersonName())).toList();
        CustomerDto customer = new CustomerDto(data.getCustomer().getName());
