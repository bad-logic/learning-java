...
public class AccountServiceImpl implements AccountService {
    ...
    public Account createAccount(String accountNumber, String customerName, AccountType type) {
        ...
        if(type == AccountType.SAVINGS){
            account.setInterestStrategy(new P1Interest(new SavingAccountInterestStrategy()));
        }else{
            account.setInterestStrategy(new P3Interest(new P2Interest(new CheckingAccountInterestStrategy())));
        }
